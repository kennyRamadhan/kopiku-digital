    ...
    <Section>
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-6">
          <article className="bg-[#FFFCF7] border border-espresso/10 border-l-4 border-l-caramel rounded-r-lg p-6 lg:p-8">
          ...
          <article className="bg-[#FFFCF7] border border-espresso/10 border-l-4 border-l-roast rounded-r-lg p-6 lg:p-8">
